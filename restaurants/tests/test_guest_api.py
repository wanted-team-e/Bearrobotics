...
post_data = {'restaurant': '1', 'price': '10000', 'number_of_party': '2', 'timestamp': '2019-12-12 03:03:03',
             'payment': 'CARD'}
...
def test_put_detail(client):
    ...
    response = client.put(path=detail_url, data= \
        {'restaurant': '1', 'price': '50000', 'number_of_party': '5', 'timestamp': '2022-02-23 13:14',
         'payment': 'CARD'})
    assert response.status_code == 200
    assert json.loads(response.content) == {'restaurant': '1', 'price': '50000', 'number_of_party': '5',
                                            'timestamp': '2022-02-23 13:14', 'payment': 'CARD'}
